		...
		$stateProvider
			...
			.state("root.shell.authenticatedAccess.infrastructure", {
				...
				views: {
					"main-content@root": {
						templateUrl:
							"app/infrastructure/infrastructure-provisioning-tabs.view.html",
			...
			.state("root.shell.authenticatedAccess.dashboards.pmoDashboard", {
				...
				redirectTo: function(transition) {
					return "root.shell.authenticatedAccess.dashboards.pmoDashboard.automationDashboard";
				}
			})
			.state(
				"root.shell.authenticatedAccess.dashboards.pmoDashboard.automationDashboard",
				{
					views: {
						"pmo-dashboard-content@root.shell.authenticatedAccess.dashboards.pmoDashboard": {
							templateUrl: "app/dashboards/automation-dashboard.view.html",
			...
			.state(
				"root.shell.authenticatedAccess.dashboards.pmoDashboard.performanceDashboard",
				{
					views: {
						"pmo-dashboard-content@root.shell.authenticatedAccess.dashboards.pmoDashboard": {
							templateUrl: "app/dashboards/performance-dashboard.view.html",
