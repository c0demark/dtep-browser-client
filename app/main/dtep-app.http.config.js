        ...
        return {
            "request": function(config) {
                ...
                try {
                    ...
                    userCredentials = JSON.parse($window.sessionStorage.getItem("dtep.user.credentials"));
                    logErrorMessage = false;
                } catch (e) {
                    if (logErrorMessage) {
                        console.log(e);
                        console.log("check sessionStorage for 'dtep.user.credentials'.");
                        console.log("It might be missing or may not be a stringified json object at all.");
                        console.log("If found then check whether it is a strigified json object.");
                        console.log("You need to stringify it explicitly to resolve this issue.");
                    }
                    logErrorMessage = false;
                }
